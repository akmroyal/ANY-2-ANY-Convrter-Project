...
const WhyChoose = () => {
    return (
        <div className='flex flex-col items-center gap-18 bg-white-700 px-48'>
            <h1 className='text-5xl text-gray-700'>Why Choose <span className='tracking-tighter'>ANY-2️⃣-ANY</span> ?</h1>
