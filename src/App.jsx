...
const ToolGrid = () => (
  <div className="p-48 flex flex-col gap-16">
    <div className="text-center">
      <h1 className="text-5xl text-gray-700">Most Popular PDF Tools</h1>
    </div>

    <div id="Alltools" className="bg grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-6">
      {tools.map((tool, index) => (
        <Link
          ...
          <div className="text-4xl pl-12">{'>'}</div>
        </Link>
      ))}
    </div>
    <div className="flex justify-center">
      <Link to="/alltools">
        <button class="rounded-md bg-indigo-600 px-3 py-2 text-xl normal font-bold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">See All PDF Tools</button>
      </Link>
    </div>
  </div>
);
...
const HeroSection = () => (
  <div className="p-12 pt-[8rem] bg-gray-100 flex flex-col items-center gap-8 justify-center">
    <h1 className=" text-9xl font-bold flex flex-col items-center"><span className="stroke text-green-500">Convert your</span> <span className="text-gray-700">file easily</span></h1>
    <p className="text-xl text-gray-600 px-12 mt-2 flex flex-col items-center">
